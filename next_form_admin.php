...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid d-flex justify-content-center" style="padding-top: 20px">
        <h2 class="fw-normal">Admin Page</h2>
        <br><br>
    </div>

    <div class="container-fluid d-flex justify-content-center" style="padding-top: 20px">
    <div class="card" style="width: 50%; max-width: 800px; border: 1px solid #ccc; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <p class="h4 d-flex justify-content-center" style="padding-top: 10px">Admin Registration</p>
        <div class="card-body">
            <form action="process_register_admin.php" method="POST">
                ...
                <div class="d-grid gap-2 col-6 mx-auto" style="padding-bottom: 20px">
                    ...
                    <a class="btn btn-secondary" href="register_admin.php">Previous</a>
